...
#Autor: Arturo Cadena Torres

require 'gtk3'

#Clase para manejar el tiempo
class Time
   def initialize(h=0, m=0) #Se inicializa con h=0, m=0
    @hh  = h #Hora string
    @min = m #Minutos sting
    @hhmm = 0
   end 
   ...
   def get_hora #Retorna la hora en formato numerico
...
def inicializar_ventana
    ...
    button.signal_connect "clicked" do
            analisis_pico_placa       #Se determina si el vehiculo puede circular o no
            analisis_info             #Se publica el resultado en un cuadro de texto
            puts "Hasta pronto: #{@p}"
        end       
